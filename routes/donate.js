...
module.exports = function (db, redis) {
  ...
  donate.route('/stripe_checkout').post((req, res, next) => {
  ...
  donate.route('/stripe_endpoint').post((req, res, next) => {
  ...
  donate.route('/brain_tree_client_token').get((req, res) => {
  ...
  donate.route('/brain_tree_checkout').post((req, res) => {
    const amount = Number(req.body.amount);
  ...
  donate.route('/thanks').get((req, res) => {
